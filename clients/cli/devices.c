...
const NmcMetaGenericInfo *const nmc_fields_dev_status[] = {
	NMC_META_GENERIC_LEAF ("DEVICE"),       /* 0 */
	NMC_META_GENERIC_LEAF ("TYPE"),         /* 1 */
	NMC_META_GENERIC_LEAF ("STATE"),        /* 2 */
	NMC_META_GENERIC_LEAF ("DBUS-PATH"),    /* 3 */
	NMC_META_GENERIC_LEAF ("CONNECTION"),   /* 4 */
	NMC_META_GENERIC_LEAF ("CON-UUID"),     /* 5 */
	NMC_META_GENERIC_LEAF ("CON-PATH"),     /* 6 */
	NULL,
};
...
const NmcMetaGenericInfo *const nmc_fields_dev_show_general[] = {
	NMC_META_GENERIC_LEAF ("NAME"),                /* 0 */
	NMC_META_GENERIC_LEAF ("DEVICE"),              /* 1 */
	NMC_META_GENERIC_LEAF ("TYPE"),                /* 2 */
	NMC_META_GENERIC_LEAF ("NM-TYPE"),             /* 3 */
	NMC_META_GENERIC_LEAF ("VENDOR"),              /* 4 */
	NMC_META_GENERIC_LEAF ("PRODUCT"),             /* 5 */
	NMC_META_GENERIC_LEAF ("DRIVER"),              /* 6 */
	NMC_META_GENERIC_LEAF ("DRIVER-VERSION"),      /* 7 */
	NMC_META_GENERIC_LEAF ("FIRMWARE-VERSION"),    /* 8 */
	NMC_META_GENERIC_LEAF ("HWADDR"),              /* 9 */
	NMC_META_GENERIC_LEAF ("MTU"),                 /* 10 */
	NMC_META_GENERIC_LEAF ("STATE"),               /* 11 */
	NMC_META_GENERIC_LEAF ("REASON"),              /* 12 */
	NMC_META_GENERIC_LEAF ("UDI"),                 /* 13 */
	NMC_META_GENERIC_LEAF ("IP-IFACE"),            /* 14 */
	NMC_META_GENERIC_LEAF ("IS-SOFTWARE"),         /* 15 */
	NMC_META_GENERIC_LEAF ("NM-MANAGED"),          /* 16 */
	NMC_META_GENERIC_LEAF ("AUTOCONNECT"),         /* 17 */
	NMC_META_GENERIC_LEAF ("FIRMWARE-MISSING"),    /* 18 */
	NMC_META_GENERIC_LEAF ("NM-PLUGIN-MISSING"),   /* 19 */
	NMC_META_GENERIC_LEAF ("PHYS-PORT-ID"),        /* 20 */
	NMC_META_GENERIC_LEAF ("CONNECTION"),          /* 21 */
	NMC_META_GENERIC_LEAF ("CON-UUID"),            /* 22 */
	NMC_META_GENERIC_LEAF ("CON-PATH"),            /* 23 */
	NMC_META_GENERIC_LEAF ("METERED"),             /* 24 */
	NULL,
};
...
const NmcMetaGenericInfo *const nmc_fields_dev_show_connections[] = {
	NMC_META_GENERIC_LEAF ("NAME"),                         /* 0 */
	NMC_META_GENERIC_LEAF ("AVAILABLE-CONNECTION-PATHS"),   /* 1 */
	NMC_META_GENERIC_LEAF ("AVAILABLE-CONNECTIONS"),        /* 2 */
	NULL,
};
...
const NmcMetaGenericInfo *const nmc_fields_dev_show_cap[] = {
	NMC_META_GENERIC_LEAF ("NAME"),             /* 0 */
	NMC_META_GENERIC_LEAF ("CARRIER-DETECT"),   /* 1 */
	NMC_META_GENERIC_LEAF ("SPEED"),            /* 2 */
	NMC_META_GENERIC_LEAF ("IS-SOFTWARE"),      /* 3 */
	NULL,
};
...
const NmcMetaGenericInfo *const nmc_fields_dev_show_wired_prop[] = {
	NMC_META_GENERIC_LEAF ("NAME"),               /* 0 */
	NMC_META_GENERIC_LEAF ("CARRIER"),            /* 1 */
	NMC_META_GENERIC_LEAF ("S390-SUBCHANNELS"),   /* 2 */
	NULL,
};
...
const NmcMetaGenericInfo *const nmc_fields_dev_show_wifi_prop[] = {
	NMC_META_GENERIC_LEAF ("NAME"),    /* 0 */
	NMC_META_GENERIC_LEAF ("WEP"),     /* 1 */
	NMC_META_GENERIC_LEAF ("WPA"),     /* 2 */
	NMC_META_GENERIC_LEAF ("WPA2"),    /* 3 */
	NMC_META_GENERIC_LEAF ("TKIP"),    /* 4 */
	NMC_META_GENERIC_LEAF ("CCMP"),    /* 5 */
	NMC_META_GENERIC_LEAF ("AP"),      /* 6 */
	NMC_META_GENERIC_LEAF ("ADHOC"),   /* 7 */
	NMC_META_GENERIC_LEAF ("2GHZ"),    /* 8 */
	NMC_META_GENERIC_LEAF ("5GHZ"),    /* 9 */
	NULL,
};
...
const NmcMetaGenericInfo *const nmc_fields_dev_show_wimax_prop[] = {
	NMC_META_GENERIC_LEAF ("NAME"),       /* 0 */
	NMC_META_GENERIC_LEAF ("CTR-FREQ"),   /* 1 */
	NMC_META_GENERIC_LEAF ("RSSI"),       /* 2 */
	NMC_META_GENERIC_LEAF ("CINR"),       /* 3 */
	NMC_META_GENERIC_LEAF ("TX-POW"),     /* 4 */
	NMC_META_GENERIC_LEAF ("BSID"),       /* 5 */
	NULL,
};
...
const NmcMetaGenericInfo *const nmc_fields_dev_wifi_list[] = {
	NMC_META_GENERIC_LEAF ("NAME"),        /* 0 */
	NMC_META_GENERIC_LEAF ("SSID"),        /* 1 */
	NMC_META_GENERIC_LEAF ("SSID-HEX"),    /* 2 */
	NMC_META_GENERIC_LEAF ("BSSID"),       /* 3 */
	NMC_META_GENERIC_LEAF ("MODE"),        /* 4 */
	NMC_META_GENERIC_LEAF ("CHAN"),        /* 5 */
	NMC_META_GENERIC_LEAF ("FREQ"),        /* 6 */
	NMC_META_GENERIC_LEAF ("RATE"),        /* 7 */
	NMC_META_GENERIC_LEAF ("SIGNAL"),      /* 8 */
	NMC_META_GENERIC_LEAF ("BARS"),        /* 9 */
	NMC_META_GENERIC_LEAF ("SECURITY"),    /* 10 */
	NMC_META_GENERIC_LEAF ("WPA-FLAGS"),   /* 11 */
	NMC_META_GENERIC_LEAF ("RSN-FLAGS"),   /* 12 */
	NMC_META_GENERIC_LEAF ("DEVICE"),      /* 13 */
	NMC_META_GENERIC_LEAF ("ACTIVE"),      /* 14 */
	NMC_META_GENERIC_LEAF ("*"),           /* 15 */
	NMC_META_GENERIC_LEAF ("DBUS-PATH"),   /* 16 */
	NULL,
};
...
const NmcMetaGenericInfo *const nmc_fields_dev_wimax_list[] = {
	NMC_META_GENERIC_LEAF ("NAME"),        /* 0 */
	NMC_META_GENERIC_LEAF ("NSP"),         /* 1 */
	NMC_META_GENERIC_LEAF ("SIGNAL"),      /* 2 */
	NMC_META_GENERIC_LEAF ("TYPE"),        /* 3 */
	NMC_META_GENERIC_LEAF ("DEVICE"),      /* 4 */
	NMC_META_GENERIC_LEAF ("ACTIVE"),      /* 5 */
	NMC_META_GENERIC_LEAF ("DBUS-PATH"),   /* 6 */
	NULL,
};
...
const NmcMetaGenericInfo *const nmc_fields_dev_show_master_prop[] = {
	NMC_META_GENERIC_LEAF ("NAME"),     /* 0 */
	NMC_META_GENERIC_LEAF ("SLAVES"),   /* 1 */
	NULL,
};
...
const NmcMetaGenericInfo *const nmc_fields_dev_show_team_prop[] = {
	NMC_META_GENERIC_LEAF ("NAME"),     /* 0 */
	NMC_META_GENERIC_LEAF ("SLAVES"),   /* 1 */
	NMC_META_GENERIC_LEAF ("CONFIG"),   /* 2 */
	NULL,
};
...
const NmcMetaGenericInfo *const nmc_fields_dev_show_vlan_prop[] = {
	NMC_META_GENERIC_LEAF ("NAME"),     /* 0 */
	NMC_META_GENERIC_LEAF ("PARENT"),   /* 1 */
	NMC_META_GENERIC_LEAF ("ID"),       /* 2 */
	NULL,
};
...
const NmcMetaGenericInfo *const nmc_fields_dev_show_bluetooth[] = {
	NMC_META_GENERIC_LEAF ("NAME"),           /* 0 */
	NMC_META_GENERIC_LEAF ("CAPABILITIES"),   /* 1 */
	NULL,
};
...
const NmcMetaGenericInfo *const nmc_fields_dev_lldp_list[] = {
	NMC_META_GENERIC_LEAF ("NAME"),                      /* 0 */
	NMC_META_GENERIC_LEAF ("DEVICE"),                    /* 1 */
	NMC_META_GENERIC_LEAF ("CHASSIS-ID"),                /* 2 */
	NMC_META_GENERIC_LEAF ("PORT-ID"),                   /* 3 */
	NMC_META_GENERIC_LEAF ("PORT-DESCRIPTION"),          /* 4 */
	NMC_META_GENERIC_LEAF ("SYSTEM-NAME"),               /* 5 */
	NMC_META_GENERIC_LEAF ("SYSTEM-DESCRIPTION"),        /* 6 */
	NMC_META_GENERIC_LEAF ("SYSTEM-CAPABILITIES"),       /* 7 */
	NMC_META_GENERIC_LEAF ("IEEE-802-1-PVID"),           /* 8 */
	NMC_META_GENERIC_LEAF ("IEEE-802-1-PPVID"),          /* 9 */
	NMC_META_GENERIC_LEAF ("IEEE-802-1-PPVID-FLAGS"),    /* 10 */
	NMC_META_GENERIC_LEAF ("IEEE-802-1-VID"),            /* 11 */
	NMC_META_GENERIC_LEAF ("IEEE-802-1-VLAN-NAME"),      /* 12 */
	NMC_META_GENERIC_LEAF ("DESTINATION"),               /* 13 */
	NMC_META_GENERIC_LEAF ("CHASSIS-ID-TYPE"),           /* 14 */
	NMC_META_GENERIC_LEAF ("PORT-ID-TYPE"),              /* 15 */
	NULL,
};
