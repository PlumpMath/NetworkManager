...
const NmcMetaGenericInfo *const nmc_fields_ip4_config[] = {
	...
	NMC_META_GENERIC_LEAF ("ADDRESS"),   /* 1 */
	NMC_META_GENERIC_LEAF ("GATEWAY"),   /* 2 */
	NMC_META_GENERIC_LEAF ("ROUTE"),     /* 3 */
	NMC_META_GENERIC_LEAF ("DNS"),       /* 4 */
	NMC_META_GENERIC_LEAF ("DOMAIN"),    /* 5 */
	NMC_META_GENERIC_LEAF ("WINS"),      /* 6 */
	NULL,
};

const NmcMetaGenericInfo *const nmc_fields_dhcp4_config[] = {
	NMC_META_GENERIC_LEAF ("GROUP"),    /* 0 */
	NMC_META_GENERIC_LEAF ("OPTION"),   /* 1 */
	NULL,
};
