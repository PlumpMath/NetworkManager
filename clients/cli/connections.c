...
const NmcMetaGenericInfo *const nmc_fields_con_show[] = {
	...
	NMC_META_GENERIC_LEAF ("UUID"),                  /* 1 */
	NMC_META_GENERIC_LEAF ("TYPE"),                  /* 2 */
	NMC_META_GENERIC_LEAF ("TIMESTAMP"),             /* 3 */
	NMC_META_GENERIC_LEAF ("TIMESTAMP-REAL"),        /* 4 */
	NMC_META_GENERIC_LEAF ("AUTOCONNECT"),           /* 5 */
	NMC_META_GENERIC_LEAF ("AUTOCONNECT-PRIORITY"),  /* 6 */
	NMC_META_GENERIC_LEAF ("READONLY"),              /* 7 */
	NMC_META_GENERIC_LEAF ("DBUS-PATH"),             /* 8 */
	NMC_META_GENERIC_LEAF ("ACTIVE"),                /* 9 */
	NMC_META_GENERIC_LEAF ("DEVICE"),                /* 10 */
	NMC_META_GENERIC_LEAF ("STATE"),                 /* 11 */
	NMC_META_GENERIC_LEAF ("ACTIVE-PATH"),           /* 12 */
	NMC_META_GENERIC_LEAF ("SLAVE"),                 /* 13 */
	NULL,
};
...
const NmcMetaGenericInfo *const nmc_fields_con_active_details_general[] = {
	NMC_META_GENERIC_LEAF ("GROUP"),        /* 0 */
	NMC_META_GENERIC_LEAF ("NAME"),         /* 1 */
	NMC_META_GENERIC_LEAF ("UUID"),         /* 2 */
	NMC_META_GENERIC_LEAF ("DEVICES"),      /* 3 */
	NMC_META_GENERIC_LEAF ("STATE"),        /* 4 */
	NMC_META_GENERIC_LEAF ("DEFAULT"),      /* 5 */
	NMC_META_GENERIC_LEAF ("DEFAULT6"),     /* 6 */
	NMC_META_GENERIC_LEAF ("SPEC-OBJECT"),  /* 7 */
	NMC_META_GENERIC_LEAF ("VPN"),          /* 8 */
	NMC_META_GENERIC_LEAF ("DBUS-PATH"),    /* 9 */
	NMC_META_GENERIC_LEAF ("CON-PATH"),     /* 10 */
	NMC_META_GENERIC_LEAF ("ZONE"),         /* 11 */
	NMC_META_GENERIC_LEAF ("MASTER-PATH"),  /* 12 */
	NULL,
};
...
const NmcMetaGenericInfo *const nmc_fields_con_active_details_vpn[] = {
	...
	NMC_META_GENERIC_LEAF ("USERNAME"),   /* 2 */
	NMC_META_GENERIC_LEAF ("GATEWAY"),    /* 3 */
	NMC_META_GENERIC_LEAF ("BANNER"),     /* 4 */
	NMC_META_GENERIC_LEAF ("VPN-STATE"),  /* 5 */
	NMC_META_GENERIC_LEAF ("CFG"),        /* 6 */
	NULL,
};
